...
async function setFamilyMemberGroup(req, res, { H, params, broadcast }) {
  const body = await readBodySafe(req, res, H);
  if (body === null) return;
  ...
  // Рассылаем обновлённый state участникам группы (раньше это делал WS-обработчик family:group_settings).
