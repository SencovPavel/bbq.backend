...
/** Чистит ответ Claude и парсит как массив позиций. Экспортируется для тестов. */
...
/** Чистит ответ Claude и парсит как объект diff-анализа. Экспортируется для тестов. */
